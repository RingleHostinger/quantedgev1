...
import { Shield, Users, Target, Plus, Brain, CheckCircle, Gift, TrendingUp, Activity, Eye, EyeOff, Newspaper, AlertTriangle, ToggleLeft, ToggleRight, FlaskConical, Trash2, Star, Zap, RefreshCw, Database, Clock, BarChart3, Play, CheckSquare, Calendar, Trophy, Filter, Crown } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { Label } from '@/components/ui/label'
import { AdminOfficialContest } from '@/components/AdminOfficialContest'
...
type Tab = 'overview' | 'games' | 'predictions' | 'free-pick' | 'users' | 'visibility' | 'briefing' | 'injuries-admin' | 'overrides' | 'bracket-model' | 'bracket-mgmt' | 'pipeline' | 'grading' | 'official-contest'
...
export default function AdminPage() {
  ...
  const tabs: { id: Tab; label: string; icon: React.ElementType }[] = [
    ...
    { id: 'official-contest', label: 'Official Contest', icon: Crown },
    ...
    <div className="p-6 space-y-6" style={{ background: '#0F0F1A', minHeight: '100%' }}>
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Official Contest */}
          {activeTab === 'official-contest' && <AdminOfficialContest />}
        </>
      )}
    </div>
  )
