        ...
        >
          ...
          {loading ? (
            ...
            <div className="text-center py-4">
              ...
              <p className="text-sm font-bold mb-1" style={{ color: '#E6E6FA' }}>Premium Pick</p>
              <p className="text-xs mb-4" style={{ color: '#6B6B80' }}>
                Today&apos;s AI Pick of the Day is available to Premium subscribers.
              </p>
      ...
      <div>
        ...
        {loading ? (
          ...
          <div className="rounded-2xl p-6 text-center"
            ...
            <p className="text-xs mb-4" style={{ color: '#6B6B80' }}>
              Full edge analysis with model lines, confidence scores, and ranked picks is available to Premium subscribers.
            </p>
            <Link href="/dashboard/settings">
        ...
        {isPremium && previewEdges.length > 0 && (
          <Link href="/dashboard/edges">
